...
package cn.modificator.launcher.folder;
...
import cn.modificator.launcher.*;
import cn.modificator.launcher.Alarm;
import cn.modificator.launcher.AppInfo;
import cn.modificator.launcher.BubbleTextView;
import cn.modificator.launcher.CellLayout;
import cn.modificator.launcher.CheckLongPressHelper;
import cn.modificator.launcher.DeviceProfile;
import cn.modificator.launcher.DropTarget.DragObject;
import cn.modificator.launcher.FastBitmapDrawable;
import cn.modificator.launcher.FolderInfo;
import cn.modificator.launcher.FolderInfo.FolderListener;
import cn.modificator.launcher.badge.BadgeRenderer;
...
import cn.modificator.launcher.OnAlarmListener;
import cn.modificator.launcher.PreloadIconDrawable;
import cn.modificator.launcher.ShortcutInfo;
import cn.modificator.launcher.SimpleOnStylusPressListener;
import cn.modificator.launcher.StylusEventHelper;
import cn.modificator.launcher.Utilities;
import cn.modificator.launcher.Workspace;
...
//            String mask = "M50 0C77.6 0 100 22.4 100 50C100 77.6 77.6 100 50 100C22.4 100 0 77.6 0 50C0 22.4 22.4 0 50 0Z";
            String mask = "m0,8c0,-4.34703 3.65297,-8 8,-8l84,0c4.34703,0 8,3.65297 8,8l0,84c0,4.34703 -3.65297,8 -8,8l-84,0c-4.34703,0 -8,-3.65297 -8,-8l0,-84z";
            MASK_SIZE = 100f;
            try {
...
//            mScaleAnimator.setDuration(CONSUMPTION_ANIMATION_DURATION);
            // TODO: 2019-04-25 图标拖到文件夹上的动画
            mScaleAnimator.setDuration(0);
