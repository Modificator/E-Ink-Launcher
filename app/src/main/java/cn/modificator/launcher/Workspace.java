...
import cn.modificator.launcher.UninstallDropTarget.DropTargetSource;
import cn.modificator.launcher.accessibility.AccessibleDragListenerAdapter;
import cn.modificator.launcher.accessibility.OverviewAccessibilityDelegate;
import cn.modificator.launcher.accessibility.OverviewScreenAccessibilityDelegate;
import cn.modificator.launcher.accessibility.WorkspaceAccessibilityHelper;
import cn.modificator.launcher.badge.FolderBadgeInfo;
...
import cn.modificator.launcher.dragndrop.DragScroller;
import cn.modificator.launcher.dragndrop.DragView;
import cn.modificator.launcher.dragndrop.SpringLoadedDragController;
import cn.modificator.launcher.folder.Folder;
import cn.modificator.launcher.folder.FolderIcon;
import cn.modificator.launcher.graphics.DragPreviewProvider;
import cn.modificator.launcher.popup.PopupContainerWithArrow;
import cn.modificator.launcher.settings.ui.TmpLocalVIew;
import cn.modificator.launcher.shortcuts.ShortcutDragPreviewProvider;
...
import cn.modificator.launcher.util.WallpaperOffsetInterpolator;
import cn.modificator.launcher.widget.PendingAddShortcutInfo;
...
public class Workspace extends PagedView
    ...
    public void onDragStart(DropTarget.DragObject dragObject, DragOptions options) {
        ...
        // TODO: 2019-02-28  拖动View 的时候workspace 缩小动画
...
//        mLauncher.enterSpringLoadedDragMode();
    ...
    protected void overScroll(float amount) {
        ...
        boolean shouldZeroOverlay = mLauncherOverlay != null &&
    ...
    public void onDragOver(DragObject d) {
        ...
        if (mDragTargetLayout != null) {
            ...
            Log.e("==========",mDragViewVisualCenter[0]+" == "+mDragViewVisualCenter[1]);
            ...
            ((TmpLocalVIew)((View)getParent().getParent()).findViewById(R.id.tmpView)).setPoint(mDragViewVisualCenter[0], mDragViewVisualCenter[1]);
            Log.e("==========",mDragTargetLayout.getLeft()+" == "+mDragTargetLayout.getTop());
