...
import cn.modificator.launcher.popup.PopupContainerWithArrow.RoundedCornerFlags;
import cn.modificator.launcher.popup.theme.IPopupThemer;

import static cn.modificator.launcher.popup.PopupContainerWithArrow.ROUNDED_BOTTOM_CORNERS;
import static cn.modificator.launcher.popup.PopupContainerWithArrow.ROUNDED_TOP_CORNERS;
...
public abstract class PopupItemView extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    public void setBackgroundWithCorners(int color, @RoundedCornerFlags int roundedCorners) {
        ...
        GradientDrawable roundRectBackground = new GradientDrawable();
        roundRectBackground.setShape(GradientDrawable.RECTANGLE);
        roundRectBackground.setCornerRadii(radii);
        // TODO: 2019-04-30 定一个 borderWidth
        roundRectBackground.setStroke(3,Color.BLACK);
        roundRectBackground.setColor(Color.WHITE);
//        ShapeDrawable roundRectBackground = new ShapeDrawable(new RoundRectShape(radii, null, null));
//        roundRectBackground.getPaint().setColor(Color.BLACK);
//        roundRectBackground.getPaint().setStyle(Paint.Style.STROKE);
