...
import cn.modificator.launcher.folder.FolderPagedView;
import cn.modificator.launcher.util.FocusLogic;
...
public class FocusHelper {
    ...
    static boolean handleHotseatButtonKeyEvent(View v, int keyCode, KeyEvent e) {
        ...
        int[][] matrix = FocusLogic.createSparseMatrix(hotseatLayout);
